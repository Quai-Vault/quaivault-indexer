-- ============================================
-- QuaiVault Indexer - Zodiac IAvatar Schema
-- ============================================
--
-- STANDALONE schema file with full Zodiac IAvatar support.
...
--   2. Create your schema: SELECT create_network_schema('dev');
...
DO $$
BEGIN
    -- Transaction type enum (base values)
...
-- ============================================
-- UPDATE SCHEMA CREATION FUNCTION
-- ============================================
-- This replaces the create_network_schema function to include Zodiac tables
...
BEGIN
    ...
    -- Transactions (with executed_by column for Zodiac)
    EXECUTE format('
    ...
    -- ============================================
    -- ZODIAC MODULE EXECUTIONS TABLE (NEW)
    -- ============================================
    ...
    RAISE NOTICE 'Schema "%" created successfully with Zodiac IAvatar support', schema_name;
END;
$$ LANGUAGE plpgsql;
...
--   SELECT create_network_schema('dev');      -- For development
...
--   ALTER ROLE authenticator SET pgrst.db_schemas TO 'public, graphql_public, testnet, dev';
...
--   SELECT drop_network_schema('dev');
